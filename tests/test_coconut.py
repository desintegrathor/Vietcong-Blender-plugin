...
"""
NJK_COCONUT02.BES roundtrip test.
Run with: blender --background --python tests/test_coconut.py
"""
...
def test_coconut_roundtrip():
    """Test NJK_COCONUT02.BES roundtrip."""
    test_file = os.path.join(PROJECT_ROOT, 'tests', 'NJK_COCONUT02.BES')
    ...
    print("=" * 60)
    print("NJK_COCONUT02.BES Roundtrip Test")
    print("=" * 60)
